...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets_landingpage/assets_landingpage/dist/css/style.css') ?>">
                        ...
                        <div class="testimonials-wrap">
                                ...
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src="<?= base_url('assets_landingpage/assets_landingpage/dist/images/testimonial-01.png') ?>" alt="Testimonial">
                                        </div>
                            ...
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src=src="<?= base_url('assets_landingpage/assets_landingpage/dist/images/testimonial-02.png') ?>" alt="Testimonial">
                                        </div>
                                        <div class="testimonial-body">
                                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                        </div>
                            ...
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src=src="<?= base_url('assets_landingpage/assets_landingpage/dist/images/testimonial-03.png') ?>" alt="Testimonial">
                                        </div>
                                        <div class="testimonial-body">
                                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                        </div>
